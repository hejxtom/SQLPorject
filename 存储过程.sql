...
CALL InsertBook("9787887182036","当代中文","吴中伟","华语教学出版社",'2007-1-1',200,10,'外语教育类');
...
DECLARE caid CHAR(5) DEFAULT '00006'; 
SELECT cid INTO caid FROM category WHERE cname=caname;
UPDATE book SET bname=NAME,bauthor=author,bpress=press,bpubdate=pubdate,moeny=meony,
bcount=bacount,cid=caid WHERE bid=id;
END;//
...
SELECT * FROM bookinfo WHERE 书号 LIKE '9787887182036';
...
CALL InsertUser('00018','王晓静','女','2000-03-25','15341629146','一卡通A证');
SELECT * FROM rederinfo WHERE 读者号 LIKE '00018';
...
CALL LendBook('9789866052231','00001');
SELECT * FROM lendinfo WHERE 书号='9789866052231';

SELECT COUNT(*) FROM lend WHERE bid='9789866052231' AND uid='00001'//
...
CALL BorrwBook('9789866052231','00001');
SELECT * FROM lendinfo WHERE 书号='9789866052231';
